...
(function () {
    ...
    var p = function () {
        ...
        var x = {
            getUrl: function (I, J) {
                ...
                I = I.replace(/#cdnhost/g, E.cdnHost);
                I = I.replace(/#cmnhost/g, E.cmnHost);
                for (var G in B) {
    ...
    Object.extend(v, {
        EMPTY_PARAGRAPH_HTML: (t.msie_nonstd ? "<p>&nbsp;</p>" : "<p><br></p>")
    });
    h.$tom = v;
    (function (e) {
        e.Util = {
    ...
    g.I.Processor.TridentStandard = {
        ...
        queryCommandState: function (z) {
            var w = this.getRange();
            if (this.hasControl() && w.collapsed === false && w.endOffset - w.startOffset === 1) {
    ...
    (function () {
        ...
        function e(I, H) {
            ...
            F = x(I);
            if (I.indexOf("http://flvs.daum.net") == 0) {
            ...
            G = "http://tvpot.daum.net/clip/ClipViewByVid.do?vid=";
            if (I.indexOf(G) == 0) {
                E = I.substr(G.length);
                I = "http://flvs.daum.net/flvPlayer.swf?vid=" + E;
                J = "swf";
                K = " allowScriptAccess='always'"
            }
            switch (J) {
        ...
        function x(F) {
            var E, G;
            if (F.indexOf("api.bloggernews.media.daum.net/static/recombox1") > -1) {
                E = 400;
                G = 80
            } else {
                if (F.indexOf("flvs.daum.net/flvPlayer") > -1) {
                    E = 502;
                    G = 399
                } else {
